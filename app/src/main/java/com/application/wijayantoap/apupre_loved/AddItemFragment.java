...
public class AddItemFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        StepperTouch stepperTouch = (StepperTouch) getView().findViewById(R.id.stepperTouch);
        stepperTouch.stepper.setMin(1);
        stepperTouch.stepper.setMax(5);
        stepperTouch.stepper.setValue(3);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Button something = (button)view,findviewbyid(r.id.button);
        // Do something
